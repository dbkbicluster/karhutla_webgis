...
var format_koordinat_kebakaran_hutan_20260902 = new ol.format.GeoJSON();
var features_koordinat_kebakaran_hutan_20260902 = format_koordinat_kebakaran_hutan_20260902.readFeatures(json_koordinat_kebakaran_hutan_20260902, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_koordinat_kebakaran_hutan_20260902 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_koordinat_kebakaran_hutan_20260902.addFeatures(features_koordinat_kebakaran_hutan_20260902);
cluster_koordinat_kebakaran_hutan_20260902 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_koordinat_kebakaran_hutan_20260902
});
var lyr_koordinat_kebakaran_hutan_20260902 = new ol.layer.Vector({
                declutter: false,
                source:cluster_koordinat_kebakaran_hutan_20260902, 
                style: style_koordinat_kebakaran_hutan_20260902,
                popuplayertitle: 'koordinat_kebakaran_hutan_20260831',
                interactive: true,
    title: 'koordinat_kebakaran_hutan_20260831<br />\
    <img src="styles/legend/koordinat_kebakaran_hutan_20260902_0.png" /> Aktif<br />\
    <img src="styles/legend/koordinat_kebakaran_hutan_20260902_1.png" /> Sudah Padam<br />' });
var group_Karhutla = new ol.layer.Group({
                                layers: [lyr_datahotspot28082026_045154_29,lyr_koordinat_kebakaran_hutan_20260902,],
                                fold: 'open',
                                title: 'Karhutla'});
...
lyr_koordinat_kebakaran_hutan_20260902.set('fieldAliases', {'Titik': 'Titik', 'Latitude': 'Latitude', 'Longitude': 'Longitude', 'Lokasi': 'Lokasi', 'Luas Terda': 'Luas Terda', 'Vegetasi': 'Vegetasi', 'Status': 'Status', 'Foto': 'Foto', 'DateStart': 'DateStart', 'DateComple': 'DateComple', });
...
lyr_koordinat_kebakaran_hutan_20260902.set('fieldImages', {'Titik': 'TextEdit', 'Latitude': 'TextEdit', 'Longitude': 'TextEdit', 'Lokasi': 'TextEdit', 'Luas Terda': 'TextEdit', 'Vegetasi': 'TextEdit', 'Status': 'TextEdit', 'Foto': 'ExternalResource', 'DateStart': '', 'DateComple': '', });
...
lyr_koordinat_kebakaran_hutan_20260902.set('fieldLabels', {'Titik': 'inline label - visible with data', 'Latitude': 'inline label - visible with data', 'Longitude': 'inline label - visible with data', 'Lokasi': 'inline label - visible with data', 'Luas Terda': 'inline label - visible with data', 'Vegetasi': 'inline label - visible with data', 'Status': 'inline label - visible with data', 'Foto': 'inline label - visible with data', 'DateStart': 'inline label - visible with data', 'DateComple': 'inline label - visible with data', });
lyr_koordinat_kebakaran_hutan_20260902.on('precompose', function(evt) {
